...
$url =mysqli_real_escape_string($conn,$_POST['blogurl']);
$pubDate =mysqli_real_escape_string($conn,$_POST['blogpubdate']);
//$pubCategory = $_POST['pubCategory'];

$add_query = "INSERT INTO blog_post VALUES ('','','$blogTitle', '$url', '$content', ,'$pubDate','','')";

if(mysqli_query($iquery=$conn,$add_query)){
